        ...
        <Page>
            ...
            <PageSection>
                ...
                {loading && !error && (
                    <div style={{ textAlign: "center", padding: "3rem" }}>
                        <Spinner size="xl" />
                        <Title headingLevel="h2" size="lg" style={{ marginTop: "1rem" }}>Loading projects...</Title>
                    </div>
                )}
                {!loading && !error && projects.length === 0 && (
                    <div style={{ textAlign: "center", padding: "3rem" }}>
                        <CubesIcon style={{ fontSize: "3rem", color: "#6a6e73", marginBottom: "1rem" }} />
                        <Title headingLevel="h2" size="lg">No stacks deployed</Title>
                        <p style={{ color: "#6a6e73", marginBottom: "1rem" }}>
                            Deploy your first compose.yaml to get started.
                        </p>
                        <Button variant="primary" onClick={handleDeploy}>
                            Deploy Stack
                        </Button>
